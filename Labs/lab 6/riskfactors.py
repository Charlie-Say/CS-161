...
# the following code allows the user to choose open and save file names at
# the command prompt. 
...
# return(heart_max_state, motor_max_state, teen_birth_max_state, smoke_max_state, obesity_max_state)
